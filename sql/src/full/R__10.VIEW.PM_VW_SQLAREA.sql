CREATE OR REPLACE VIEW "XXYSS_ADMIN"."PM_VW_SQLAREA" ("DB", "RUN_ID", "SQL_ID", "SORTS", "EXECUTIONS", "LOADS", "PARSE_CALLS", "DISK_READS", "BUFFER_GETS", "ROWS_PROCESSED", "KEPT_VERSIONS") AS 
  SELECT
     	/* $Header$ */
