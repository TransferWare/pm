...
CREATE SEQUENCE "PM_RUN_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/

--@sql/PM_OWNER/src/full/01.SEQUENCE.PM_SQL_SEQ.sql
CREATE SEQUENCE "PM_SQL_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
...
CREATE UNIQUE INDEX "PM_ARE_PK" ON "PM_SQLAREA" ("DB", "HASH_VALUE", "ADDRESS", "FIRST_LOAD_TIME", "PARSING_USER_NAME", "PARSING_SCHEMA_NAME", "RUN_ID") 
...
CREATE INDEX "PM_ART_1" ON "PM_SQLAREA_TMP" ("DB", "FIRST_LOAD_TIME", "ADDRESS", "HASH_VALUE", "PARSING_USER_NAME", "PARSING_SCHEMA_NAME")
/


--@sql/PM_OWNER/src/full/16.INDEX.PM_SQL_CURRENT.sql
CREATE UNIQUE INDEX "PM_CUR_PK" ON "PM_SQL_CURRENT" ("DB", "HASH_VALUE", "ADDRESS") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA"
/
...
CREATE UNIQUE INDEX "PM_SET_PK" ON "PM_SYSTEM_EVENT_TMP" ("DB", "RUN_ID", "EVENT")
/
...
CREATE UNIQUE INDEX "PM_SID_PK" ON "PM_SQL_ID" ("SQL_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA"
/
...
ALTER TABLE "PM_SQLAREA" ADD CONSTRAINT "PM_ARE_PK" PRIMARY KEY ("DB", "HASH_VALUE", "ADDRESS", "FIRST_LOAD_TIME", "PARSING_USER_NAME", "PARSING_SCHEMA_NAME", "RUN_ID") ENABLE
/


--@sql/PM_OWNER/src/full/19.CONSTRAINT.PM_SQL_CURRENT.sql
ALTER TABLE "PM_SQL_CURRENT" ADD CONSTRAINT "PM_CUR_PK" PRIMARY KEY ("DB", "HASH_VALUE", "ADDRESS") ENABLE
/
...
ALTER TABLE "PM_SYSTEM_EVENT_TMP" ADD CONSTRAINT "PM_SET_PK" PRIMARY KEY ("DB", "RUN_ID", "EVENT") ENABLE
/
...
ALTER TABLE "PM_SYSTEM_EVENT" ADD CONSTRAINT "PM_SEV_PK" PRIMARY KEY ("DB", "RUN_ID", "EVENT") ENABLE
/
...
ALTER TABLE "PM_SESSION_TMP" ADD CONSTRAINT "PM_STP_PK" PRIMARY KEY ("DB", "RUN_ID", "SID") ENABLE
/
...
ALTER TABLE "PM_SYSTEM_EVENT" ADD CONSTRAINT "PM_SEV_RUN_FK1" FOREIGN KEY ("DB", "RUN_ID")
    REFERENCES "PM_RUN" ("DB", "RUN_ID") ENABLE
/
