...
,p_last_upd_yyyymmddhh24miss=>'20210519053544'
);
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1915023245977371)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(29936626380276707)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1915432876985095)
,p_name=>'ApplyFilter'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(1915023245977371)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1915875526985096)
,p_event_id=>wwv_flow_api.id(1915432876985095)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
